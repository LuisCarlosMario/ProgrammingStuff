function Rho = RhoVG4D(C, G, M, S, K, r ,q, tau, n1, m1, k1)
    % Inputs:
    ...
    D = DeltaVG4D(C, G, M, S, K, r ,q, tau,  n1, m1,k1);                                % D is defined 
    [COP,POP,lo,mu] = EuropeanOptionSumFormula(C, G, M, S, K, r ,q, tau,  n1, m1,k1);
    Rho = -tau*COP + tau*S*D;
end