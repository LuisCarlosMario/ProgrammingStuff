function [TM,G,s] = GammaProcessRevenge(a, b, T, dt)
    ...
    g = JohnksGammaGeneratorRevenge(V.*DT,TM) / b;     % g is defined as the matrix with element The Johnks Gamma Generator
