function COP = CallOptionVGRevenge(C, G, M, S0, K, r ,q, T, dt, ite)
    ...
    for i = 1:ite
        [X,TM,S,s,m] = StockPriceVGRevenge(C, G, M, S0, r ,q, T, dt);   % S is defined as the stock price simulation matrix for each time value of in vector T
