function COP = MVarianceGammaDerivative(C, G, M, S, K, r ,q, tau, n1, m1,k1)
            ...
            for n = 0:n1
                for m = 0:m1
                    for k = 0:k1
                        ...
                        Mat(l,t,n+1,m+1,k+1) = ((n+C*tau(t))/M)*MatO;
            ...
            for n = 0:n1
                for m = 0:m1
                    for k = 0:k1
                        ...
                        Nat(l,t,n+1,m+1,k+1) = ((C*tau(t) -1-2*C*tau(t)-k+n-m)/M)*NatO;
                    end                                                                                                                                                                                                         % corresponding K(l), tau(t), n, m and k computed according to the Variance Gamma formula 
                end
            end
        end
                ...
                for m = 0:m1
                    for k = 0:k1
                        if  (lo(l,t) > 0)
                            ...
                            Kat(l,t,n+1,m+1,k+1) = ((C*tau(t)+n)/M)*KatO;
